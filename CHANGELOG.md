...
- b2f004b: Verified wire-format conformance against rkyv 0.8.18 (the pinned version moved up from 0.8.14). Wire bytes are unchanged between the two, so no codec changes were needed.
